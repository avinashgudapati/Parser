...
public:
  ...
  static Files showFiles(const Path& path, Patterns& patts, Options &option);
  static std::vector<std::string> showAllDirectories(std::string &baseDirectory, std::vector<std::string> &directories);
